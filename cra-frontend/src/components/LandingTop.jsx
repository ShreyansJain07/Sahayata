...
import { GoLaw } from "react-icons/go";
  export default function LandingTop() {
    ...
    return (<>
       ...
       <div className="flexup"><div className='home-content-top-title' ><span >Special platform</span> for Special Needs</div>
      <div className='home-content-top' style={{fontFamily:"Sunflower",fontWeight:"bold"}}>
      <p className='p1'>Empowering Every Ability : <br />Journey to a Fulfilling Career Starts Here.</p>
      <img className='home-image' src={blob} alt="profile" />
      </div></div >
      <div className='home-content-below-title' >We understand the unique strengths and talents that individuals <br />with disabilities bring to the workforce</div>
     <div className="buttons">
      ...
      <div className="company">
        <p className='p2'>Helped People to get into <span style={{color:"#6c76f2"}} > 100 + </span>Great Companies Worldwide</p>
      ...
      <img className="pie2"src={pie2} alt=""  style={{position:"absolute",opacity:"55%",zIndex:"1"}}/>
        ...
        <p className='section-title'>Unlock Your Potential. Excel in Your Career <br />Journey with Inclusive Employment!</p>
        <p className="subheading">Discover Your Path. Navigate Your Career Journey with Confidence. Personalized Job Matching.</p>
<p className='subheading' id="2" style={{marginTop:"-15px"}}>Empowering Solutions. Accessibility Advocacy. Inclusive Employment Opportunities.</p>
